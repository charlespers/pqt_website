...
export default function Navbar() {
  ...
  return (
    <nav className="navbar fixed top-0 left-0 w-full z-50">
      <div className="navbar-container flex items-center justify-between w-full max-w-6xl mx-auto px-4 py-2">
        {/* Logo */}
        <Link href="/">
        ...
        <h1 className="text-lg sm:text-xl font-bold text-orange-500 text-center flex-grow mx-4">
